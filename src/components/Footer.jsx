    ...
    <div className='max-w-[1240px] mx-auto py-16  px-4 grid lg:grid-cols-3 gap-8 text-gray-100'>
        <div>
            ...
            <p className='py-4'>Lorem ipsum dolor sit amet consectetur adipisicing elit. 
                Tempore amet tempora omnis, voluptates vel facilis possimus debitis,
                 tenetur at corrupti ducimus blanditiis vero aperiam eligendi!
                  Quas soluta accusamus eum iure.
            </p>
        ...
        <div className='lg:col-span-2 mt-6 flex justify-between '>
            ...
            <div>
                ...
                <ul>
                    ...
                    <li className='py-2 text-sm'>Documentaton</li>
